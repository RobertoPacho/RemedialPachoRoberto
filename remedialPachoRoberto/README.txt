...
a persistence unit "remedialPachoRobertoPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "remedialPachoRoberto\pom.xml":
...
artifact ("remedialPachoRoberto.war") is already built. You can build
